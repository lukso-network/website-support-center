...
If you need to enhance the security of your Universal Profile or recover access to the Universal Profile Browser Extension, there are several methods available:
...
- **Backup and Restore**: The [Backup and Restore](./backup-and-restore.md) feature allows users to export **all of their UPs** to a backup file securely to be restored later.
...
- **Export Main Controller Private Key (Advanced)**: You can export the main controller private key from the settings of the Browser Extension. Make sure to export the text into a file and store it safe. This controller private key will allow anyone to regain access to the UP, based on the controller's permissions.
